...
class pmlc_neutron (
  ...
  $certificate_name            = $::pmlc_neutron::params::certificate_name,
  $private_key_file            = $::pmlc_neutron::params::private_key_file,
  $integrated_topology_service = $::pmlc_neutron::params::integrated_topology_service,
  $apic_agent_report_interval  = $::pmlc_neutron::params::apic_agent_report_interval,
  $apic_agent_poll_interval    = $::pmlc_neutron::params::apic_agent_poll_interval,
